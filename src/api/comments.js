...
export const addComment = (data) => axios.post( 
        `http://localhost:4000/comments`,
        data
    )

export const updateComment = (data) => axios.put( 
    `http://localhost:4000/comments/${data.id}`,
    data
)

export const removeComment = (id) => axios.delete(`http://localhost:4000/comments/${id}`,)